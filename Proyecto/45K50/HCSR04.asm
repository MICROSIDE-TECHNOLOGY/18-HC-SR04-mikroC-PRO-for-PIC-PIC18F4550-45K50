...
;HCSR04.c,51 :: 		void main() org 0x2000 {
;HCSR04.c,52 :: 		ADCON1 = 0x0F;
	MOVLW       15
	MOVWF       ADCON1+0 
;HCSR04.c,53 :: 		C1ON_bit = 0;                      // Deshabilita los comparadores
	BCF         C1ON_bit+0, BitPos(C1ON_bit+0) 
;HCSR04.c,54 :: 		C2ON_bit = 0;
	BCF         C2ON_bit+0, BitPos(C2ON_bit+0) 
;HCSR04.c,56 :: 		HCSR04_Init(3);                    // Conexión con el sensor HCSR04
	MOVLW       3
	MOVWF       FARG_HCSR04_Init_mode+0 
	CALL        _HCSR04_Init+0, 0
;HCSR04.c,58 :: 		Lcd_Init();                        // Inicializa el LCD
	CALL        _Lcd_Init+0, 0
;HCSR04.c,59 :: 		Lcd_Cmd(_LCD_CLEAR);               // Limpia el LCD
	MOVLW       1
	MOVWF       FARG_Lcd_Cmd_out_char+0 
	CALL        _Lcd_Cmd+0, 0
;HCSR04.c,60 :: 		Lcd_Cmd(_LCD_CURSOR_OFF);          // Posiciona el cursor del LCD
	MOVLW       12
	MOVWF       FARG_Lcd_Cmd_out_char+0 
	CALL        _Lcd_Cmd+0, 0
;HCSR04.c,62 :: 		while(1)
L_main10:
;HCSR04.c,64 :: 		Distancia = HCSR04_Read()/10;   //Se obtiene la lectura del sensor
	...
	MOVF        R1, 0 
	MOVWF       _Distancia+1 
;HCSR04.c,65 :: 		WordToStrWithZeros( Distancia, text );  //Se convierte el valor que se imprimirá en el LCD
	MOVF        R0, 0 
...
;HCSR04.c,66 :: 		Lcd_Out( 1, 1, "Dist.: " );
	...
	CALL        _Lcd_Out+0, 0
;HCSR04.c,67 :: 		Lcd_Out_CP( text );
	MOVLW       _text+0
	MOVWF       FARG_Lcd_Out_CP_text+0 
	MOVLW       hi_addr(_text+0)
	MOVWF       FARG_Lcd_Out_CP_text+1 
	CALL        _Lcd_Out_CP+0, 0
;HCSR04.c,68 :: 		Lcd_Out_CP( "cm" );
	MOVLW       ?lstr2_HCSR04+0
	MOVWF       FARG_Lcd_Out_CP_text+0 
	MOVLW       hi_addr(?lstr2_HCSR04+0)
	MOVWF       FARG_Lcd_Out_CP_text+1 
	CALL        _Lcd_Out_CP+0, 0
;HCSR04.c,69 :: 		Delay_ms( 300 );
	MOVLW       19
	MOVWF       R11, 0
	MOVLW       68
	MOVWF       R12, 0
